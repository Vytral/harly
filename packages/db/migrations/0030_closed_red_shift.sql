...
ALTER TABLE "workspace_settings" ADD COLUMN "require_2fa" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "workspace_settings" ADD COLUMN "acquisition_source" text;--> statement-breakpoint
ALTER TABLE "workspace_settings" ADD COLUMN "chat_enabled" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "workspace_settings" ADD COLUMN "chat_provider" text;--> statement-breakpoint
ALTER TABLE "workspace_settings" ADD COLUMN "chat_webhook_ciphertext" text;--> statement-breakpoint
ALTER TABLE "workspace_settings" ADD COLUMN "chat_webhook_iv" text;--> statement-breakpoint
ALTER TABLE "workspace_settings" ADD COLUMN "chat_webhook_tag" text;--> statement-breakpoint
ALTER TABLE "workspace_settings" ADD COLUMN "chat_events" jsonb DEFAULT '[]'::jsonb NOT NULL;--> statement-breakpoint
ALTER TABLE "workspace_settings" ADD COLUMN "turnstile_enabled" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "workspace_settings" ADD COLUMN "turnstile_site_key" text;--> statement-breakpoint
ALTER TABLE "workspace_settings" ADD COLUMN "turnstile_secret_ciphertext" text;--> statement-breakpoint
ALTER TABLE "workspace_settings" ADD COLUMN "turnstile_secret_iv" text;--> statement-breakpoint
ALTER TABLE "workspace_settings" ADD COLUMN "turnstile_secret_tag" text;--> statement-breakpoint
