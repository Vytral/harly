...
description: "Configure your first Harly workspace — invite the hiring team, assign roles, define the pipeline, publish the career page, and open a first job posting."
---
