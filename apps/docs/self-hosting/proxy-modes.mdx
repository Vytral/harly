---
title: "Proxy modes"
description: "Compare the built-in Caddy proxy, an external reverse proxy, and local-only mode for self-hosted Harly, and trust upstream proxies for correct client IPs."
---
