...
description: "Review candidate records, move applications through pipeline stages, collaborate with the hiring team, and reject or hire with a clear documented reason."
---
...
<Frame caption="Candidate list and pipeline stages with synthetic demo data.">
  <img
    src="/images/features/candidates-pipeline.webp"
    alt="Harly candidate list with filters, candidate profiles, and pipeline stages."
  />
</Frame>
...
<Frame caption="Global candidate search and navigation across the recruiting workspace.">
  <img
    src="/images/features/candidate-search.webp"
    alt="Harly global search finding a synthetic candidate and navigation destinations."
  />
</Frame>
