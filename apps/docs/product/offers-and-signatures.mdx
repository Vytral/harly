...
description: "Generate an offer letter, send it for e-signature with Harly Signing or DocuSeal, and safely confirm the accepted state before you close out a hire."
---
