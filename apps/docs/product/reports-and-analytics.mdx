...
<Frame caption="Hiring performance, pipeline health, and time-to-hire reporting.">
  <img
    src="/images/features/reports.webp"
    alt="Harly reports dashboard showing applications, hires, time to hire, offer acceptance, and hiring trends."
  />
</Frame>
