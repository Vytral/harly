...
description: "Give candidates a secure portal to track applications, upload documents, sign in with magic link or OAuth, and exercise data access and deletion rights."
---
...
<Frame caption="Candidate portal application progress and interview details.">
  <img
    src="/images/features/candidate-portal.webp"
    alt="Harly candidate portal showing application progress, an interview, and a candidate profile."
  />
</Frame>
