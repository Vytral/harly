...
description: "Schedule candidate interviews with connected calendars and video providers, run structured scorecards, and recover cleanly when a provider outage hits booking."
---
...
<Frame caption="Interview record with scheduling, video, attendee, and evaluation controls.">
  <img
    src="/images/features/interviews.webp"
    alt="Harly interview record showing a scheduled video interview, attendee, sync status, and evaluation actions."
  />
</Frame>
