...
description: "Import candidate profiles from Ashby into a Harly job using an Ashby API key, with field mapping, incremental sync, and duplicate handling controls."
---
