...
description: "Understand how Harly integrations work — installation credentials, workspace-level connections, sync behavior, permissions, and provider outage recovery."
---
...
<Frame caption="Integration settings for calendars, video, communication, and workspace tools.">
  <img
    src="/images/features/integrations.webp"
    alt="Harly integrations settings showing calendar, video, notification, and communication providers."
  />
</Frame>
...
| E-signature | Harly Sign, DocuSeal | Built-in signing or optional provider connection |
