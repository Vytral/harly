---
title: "File storage"
description: "Choose between local volume storage and S3-compatible object storage for candidate resumes, offer letters, uploaded documents, and email attachments."
---
