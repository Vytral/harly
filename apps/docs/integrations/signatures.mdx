...
description: "Configure Harly Sign or DocuSeal to send offer letters for e-signature and verify the signed state safely before you close out a hire in Harly."
---
