...
description: "Create rollback archives, ship encrypted backups off-host, restore a Harly installation, and verify database and file recovery with a throwaway instance."
---
