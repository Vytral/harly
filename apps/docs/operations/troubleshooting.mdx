...
description: "Diagnose common Harly failures — installation errors, proxy misconfiguration, scheduler stalls, email delivery, integrations, API errors, and realtime drops."
---
