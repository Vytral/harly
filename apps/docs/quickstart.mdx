...
<Frame caption="Harly after installation: a candidate pipeline using synthetic demo data.">
  <img
    src="/images/features/candidates-pipeline.webp"
    alt="Harly candidate list with filters and pipeline stages using synthetic demo data."
  />
</Frame>
