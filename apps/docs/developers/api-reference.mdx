...
description: "Inventory of every Harly REST resource with its endpoints, required scopes, mutation semantics, response shapes, and standard error status codes."
---
...
| Automations | Withdrawn (HTTP 410) | Dashboard only until automations v2 |
