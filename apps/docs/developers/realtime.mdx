...
description: "Consume Harly's server-sent events stream to receive live workspace, candidate, and interview updates in your app without polling or page refreshes."
---
