---
title: "API overview"
description: "Build integrations against Harly's versioned REST API — authentication with scoped keys, pagination, idempotency keys, rate limits, and safe retries."
---
