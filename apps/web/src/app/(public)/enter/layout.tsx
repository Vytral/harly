import { EnterBrandPanel } from "./_components/enter-brand-panel";
...
export default function EnterLayout({
  ...
  return (
    <div className="light relative min-h-[100dvh] bg-paper text-foreground antialiased md:grid md:grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)] lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
      {/* Brand panel — evergreen, hidden on mobile (its logo re-appears in the
          right panel below md). Mirrors the /setup split-screen so the demo
          entry feels like a real product moment, not a login form. */}
      <EnterBrandPanel />
