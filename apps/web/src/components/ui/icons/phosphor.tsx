...
export function EyeSlashDuotoneIcon(props: IconProps) {
  return (
    <Svg {...props}>
      <g fill="currentColor">
        <path
...
/** Email templates empty-state illustration. */
...
export function StarFillIcon(props: IconProps) {
  return (
    <Svg {...props}>
      <path fill="currentColor" d="m234.29 114.85l-45 38.83L203 211.75a16.4 16.4 0 0 1-24.5 17.82L128 198.49l-50.53 31.08A16.4 16.4 0 0 1 53 211.75l13.76-58.07l-45-38.83A16.46 16.46 0 0 1 31.08 86l59-4.76l22.76-55.08a16.36 16.36 0 0 1 30.27 0l22.75 55.08l59 4.76a16.46 16.46 0 0 1 9.37 28.86Z" />
    </Svg>
  );
}

/** Toggle target for "make active" on an email template card. */
...
/** Video-mode interview chip. */
export function VideoCameraIcon(props: IconProps) {
  return (
    <Svg {...props}>
      <path fill="currentColor" d="M251.77 73a8 8 0 0 0-8.21.39L208 97.05V72a16 16 0 0 0-16-16H32a16 16 0 0 0-16 16v112a16 16 0 0 0 16 16h160a16 16 0 0 0 16-16v-25l35.56 23.71A8 8 0 0 0 248 184a8 8 0 0 0 8-8V80a8 8 0 0 0-4.23-7M192 184H32V72h160zm48-22.95l-32-21.33v-23.44L240 95Z" />
    </Svg>
  );
}

/** Phone-mode interview chip. */
...
export function ChatCircleDotsIcon(props: IconProps) {
  return (
    <Svg {...props}>
      <path
        fill="currentColor"
        d="M128 24a104 104 0 0 0-91.82 152.88l-11.35 34.05a16 16 0 0 0 20.24 20.24l34.05-11.35A104 104 0 1 0 128 24m-36 96a12 12 0 1 1 12-12a12 12 0 0 1-12 12m36 0a12 12 0 1 1 12-12a12 12 0 0 1-12 12m36 0a12 12 0 1 1 12-12a12 12 0 0 1-12 12"
      />
    </Svg>
  );
}
...
export function CircleDashedIcon(props: IconProps) {
  return (
    <Svg {...props}>
      <path
        fill="currentColor"
        d="M85.13 46.28a8 8 0 0 1-3.34 10.82a88.6 88.6 0 0 0-24.69 20a8 8 0 0 1-12.24-10.32a104.5 104.5 0 0 1 29.45-23.8a8 8 0 0 1 10.82 3.3M56.86 172.44a8 8 0 0 0-11.24 1.3a8 8 0 0 0 1.3 11.24l.3.23a8 8 0 0 0 11-1.62a8 8 0 0 0-1.35-11.15Zm-16.4-51.32a8 8 0 0 0-9.4 6.3A105 105 0 0 0 29 148.1a8 8 0 0 0 8 7.53h.47a8 8 0 0 0 7.53-8.45a89 89 0 0 1 1.76-17.66a8 8 0 0 0-6.3-9.4M128 40a89 89 0 0 1 8.85.45a8 8 0 1 0 1.61-15.92a105 105 0 0 0-20.9 0a8 8 0 1 0 1.61 15.92A89 89 0 0 1 128 40m91.29 42.75a8 8 0 0 0-14.13 7.51a88.6 88.6 0 0 1 8.09 23.16a8 8 0 0 0 7.83 6.36a8 8 0 0 0 7.83-9.63a104.5 104.5 0 0 0-9.62-27.4Zm-9.17 89.69a8 8 0 0 0-11.15 1.35a88.6 88.6 0 0 1-18.44 17.31a8 8 0 0 0 9.2 13.09a104.6 104.6 0 0 0 21.74-20.4a8 8 0 0 0-1.35-11.35Zm-38.79 33.13a88 88 0 0 1-22.61 6.4a8 8 0 0 0 1.09 15.92a8 8 0 0 0 1.11-.08a104.5 104.5 0 0 0 26.72-7.56a8 8 0 1 0-6.3-14.7Zm-58.61 6.34a88.6 88.6 0 0 1-22.51-6.65a8 8 0 1 0-6.55 14.6a104.6 104.6 0 0 0 26.6 7.85a8 8 0 0 0 2.46-15.8"
      />
    </Svg>
  );
}
