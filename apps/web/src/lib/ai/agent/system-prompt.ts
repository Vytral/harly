...
- You can PROPOSE changes: move or reject in the pipeline; create tasks; add notes, tags, or scorecards; generate an AI candidate score; create / send / decide offers; schedule interviews; add to or assign from the talent pool; and send candidate emails.
